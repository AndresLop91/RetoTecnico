...
public class TraducirDeInglesAIngles implements Task {

    private String palabra;

    public TraducirDeInglesAIngles(String palabra){
        this.palabra = palabra;
    }


    public static TraducirDelEspaniolAlEspaniol laPalabraInglesAIngles(String palabra) {
