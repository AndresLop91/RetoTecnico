...
public class TraducirDelEspaniolAlPortugues implements Task {

    private String palabra;

    public TraducirDelEspaniolAlPortugues(String palabra){
        this.palabra = palabra;
    }


    public static TraducirDelEspaniolAlEspaniol laPalabraEspaniolAlPortugues(String palabra) {
